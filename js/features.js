...
const TYPES = [
  ...
  {k:"play", label:"Playground", icon:"🎛️", route:() => "#/playground", blurb:"Sliders that teach — v, θ, Q, n"},
  ...
  {k:"timetable", label:"Timetable", icon:"🗓️", route:() => "#/playground", blurb:"Weak-area aware smart plan"},
];
...
const GLOBAL_FEATURES = [
  ...
  {id:"g-cert", name:"Blockchain Cert", icon:"⛓️", route:"#/labs", blurb:"local ledger tmj_certs", subject:"C", type:"global"},
  ...
  {id:"g-arch", name:"The Architect Easter", icon:"🏛️", route:"#/labs", blurb:"7 chapters + 3d streak", subject:"M", type:"global"},
  ...
  {id:"g-playback", name:"Formula Playground", icon:"🎛️", route:"#/playground", blurb:"Projectile/Lens/Nernst/nCr", subject:"P", type:"global"},
  {id:"g-timetable", name:"Smart Timetable", icon:"🗓️", route:"#/playground", blurb:"Weak-aware hours", subject:"C", type:"global"},
];
